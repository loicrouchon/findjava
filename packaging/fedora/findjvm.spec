...
License:   Apache-2.0
URL:       https://github.com/loicrouchon/findjvm
Source0:   https://github.com/loicrouchon/findjvm/archive/refs/tags/v${version}.tar.gz
# Source0:   https://github.com/loicrouchon/findjvm/archive/refs/heads/<BRANCH>.zip

BuildArch: x86_64 aarch64
BuildRequires: make, java-latest-openjdk-devel, golang

%description
findjvm is a command-line tool for finding an appropriate installed JVM to run your program.
